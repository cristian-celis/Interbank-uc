...
def get_current_supervisor(
    ...
    if asesor.get("perfil") not in {"supervisor", "administrador", "super_operador"}:
        raise HTTPException(status_code=403, detail="Requiere perfil supervisor o administrador")
    return asesor
